...
export function BalanceCard({ 
  ...
  const getGradient = () => {
    ...
    return "from-[#7C3AED] via-[#8B5CF6] to-[#6366F1]";
  };
  ...
  const getProgressColor = () => {
    ...
    return "bg-gradient-to-r from-white via-purple-100 to-white";
  };
      ...
      <div className="relative z-10">
        ...
        >
          <Link href="/purchase" className="flex-1">
            <motion.button
              className="w-full bg-white text-purple-600 py-3 px-4 rounded-xl font-semibold text-sm shadow-lg"
